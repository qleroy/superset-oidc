...
CUSTOM_AUTH_USER_REGISTRATION_ROLE = "Gamma" # Role de base par défaut synchronisé lors du login
...
OIDC_VALID_ISSUERS = [ "https://superset-oidc.kantan.fr/realms/myrealm" ]
